...
public class Settings extends JFrame {
	...
	public Settings() {
		...
		final JCheckBox chckbxEmailTestMode = new JCheckBox("Email test mode");
		panel.add(chckbxEmailTestMode, "2, 10");

		boolean t = Boolean.parseBoolean(API.get("testmode"));

		chckbxEmailTestMode.setSelected(t);
		...
		save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				API.put("testmode",
						String.valueOf(chckbxEmailTestMode.isSelected()));
