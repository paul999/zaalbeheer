...
@XmlRootElement(name = "saveZaalDienstResponse", namespace = "http://server.ttv.sohier.paul.nl/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "saveZaalDienstResponse", namespace = "http://server.ttv.sohier.paul.nl/")
public class SaveZaalDienstResponse {
