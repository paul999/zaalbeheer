...
@XmlRootElement(name = "getSavedDagResponse", namespace = "http://server.ttv.sohier.paul.nl/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getSavedDagResponse", namespace = "http://server.ttv.sohier.paul.nl/")
public class GetSavedDagResponse {
