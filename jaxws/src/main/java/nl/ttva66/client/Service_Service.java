...
@WebServiceClient(name = "Service", 
                  wsdlLocation = "http://vps.hosthuis.nl:7070/server-0.0.3-SNAPSHOT/Service/ServiceBean?wsdl",
...
public class Service_Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://vps.hosthuis.nl:7070/server-0.0.3-SNAPSHOT/Service/ServiceBean?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://vps.hosthuis.nl:7070/server-0.0.3-SNAPSHOT/Service/ServiceBean?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
